...
<head>
<meta charset="utf-8">
<title>CAROLE MEYER - COMMUNICATION</title>
...
<div class='container'>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class='active'><a href="index.php">Bienvenue</a></li>
        <li class="dropdown" >
...
mais détesté par le reste du service pour son caractère difficile. Les jeunes
professionnels demandaient rapidement leur transfert. À la surprise
générale, l’attitude de l’expert senior a complètement changé après l’atelier,
les demandes de transfert ont cessé et nous avons réduit au minimum les
frais de recherche de nouveaux employés. Personne ne s’attendait à une
formation si riche ni à un bénéfice si concret ! Merci Carole !&quot;
              </p>
...
que bon lui semblait. Il n’y avait pas de pilote dans l’avion. J’ai grandement
